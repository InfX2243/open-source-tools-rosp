...
import { Sparkles, Sun, Moon, ShieldCheck, ChevronDown, Check, Coins } from 'lucide-react';
import { PROMPT_PRESETS } from '../core/presets';
    ...
    <header className={styles.header}>
      <div className={styles.brand}>
        <div className={styles.logoIcon}>
          <Coins size={22} className={styles.coinsIcon} />
        </div>
        <div className={styles.brandInfo}>
          <div className={styles.brandTitleGroup}>
            <h1 className={styles.brandName}>TokenCost</h1>
            <span className={styles.versionBadge}>v1.0</span>
          </div>
          <p className={styles.brandTagline}>AI Prompt, Token Cost & Latency Benchmark Playground</p>
        </div>
      </div>
      ...
      <div className={styles.actions}>
          ...
          {presetsOpen && (
            <>
              ...
              <div className={styles.dropdownMenu}>
                <div className={styles.dropdownHeader}>Sample Prompt Templates</div>
        ...
        <div className={styles.privacyPill} title="100% Client-Side Processing. No prompt data leaves your browser.">
          <ShieldCheck size={15} />
